...
def submit_faq(request, form_class=SubmitFaqForm,
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			messages.add_message(request, messages.SUCCESS, "Your question was submitted and will be reviewed by the site administrator for possible inclusion in the FAQ." , fail_silently = True)
